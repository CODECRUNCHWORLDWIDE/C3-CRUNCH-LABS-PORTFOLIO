...
| [resources.md](./01-resources.md) | Curated, free, current references — Scrum Guide, Pro Git, JDK/Maven/Actions docs |
| [lecture-notes/01-how-a-real-sprint-runs.md](./02-lecture-notes/01-how-a-real-sprint-runs.md) | Agile vs Scrum vs Kanban; the ceremonies, roles, and artifacts; INVEST stories |
| [lecture-notes/02-git-for-teams.md](./02-lecture-notes/02-git-for-teams.md) | Git internals, trunk-based development, branches, merge vs rebase, PR review |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the short, focused drills |
| [exercises/exercise-01-jdk-and-maven-setup.md](./03-exercises/exercise-01-jdk-and-maven-setup.md) | Install JDK 21 with SDKMAN, scaffold a Maven project, branch + commit + open a PR |
| [exercises/exercise-02-hello-jdk21.java](./03-exercises/exercise-02-hello-jdk21.java) | Runnable JDK 21 single-file program — fill in the TODOs, run with `java` |
| [exercises/exercise-03-ci.yml](./03-exercises/exercise-03-ci.yml) | A real GitHub Actions workflow that builds and tests on every push and PR |
| [challenges/README.md](./04-challenges/00-overview.md) | What the challenge is and how it's graded |
| [challenges/challenge-01-merge-conflict-rebase.md](./04-challenges/challenge-01-merge-conflict-rebase.md) | Resolve a deliberate three-way conflict and rebase a messy branch clean |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for "Stand up the Crunch Tracker team repo and board" |
