...
| [resources.md](./resources.md) | Curated Spring Security, JWT, REST, and OWASP references |
| [lecture-notes/01-rest-api-design-that-ages-well.md](./lecture-notes/01-rest-api-design-that-ages-well.md) | Versioning, idempotency, pagination, filtering, the error contract, CORS |
| [lecture-notes/02-stateless-auth-with-spring-security-6.md](./lecture-notes/02-stateless-auth-with-spring-security-6.md) | The filter chain, BCrypt, JWTs, the bearer filter, method security, ownership |
| [exercises/README.md](./exercises/README.md) | Index of the week's exercises |
| [exercises/exercise-01-design-the-v1-surface.md](./exercises/exercise-01-design-the-v1-surface.md) | Design and document the versioned, paginated v1 API on paper and in code |
| [exercises/exercise-02-jwt-service.java](./exercises/exercise-02-jwt-service.java) | Fill-in-the-TODO JWT issue/validate service with jjwt |
| [exercises/exercise-03-security-config.java](./exercises/exercise-03-security-config.java) | Wire the Spring Security 6 filter chain, BCrypt, and the bearer filter |
| [challenges/README.md](./challenges/README.md) | Index of weekly challenges |
| [challenges/challenge-01-ownership-authorization.md](./challenges/challenge-01-ownership-authorization.md) | Enforce a `@PreAuthorize` ownership rule and prove the 403s fire |
| [quiz.md](./quiz.md) | 10 multiple-choice questions |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for adding accounts and per-user scoping to Crunch Tracker |
