...
| [resources.md](./resources.md) | Curated React Navigation, Zustand, Expo, and TypeScript links |
| [lecture-notes/01-multi-screen-navigation.md](./lecture-notes/01-multi-screen-navigation.md) | React Navigation, typed routes, stacks, tabs, nesting, deep links |
| [lecture-notes/02-managing-state-on-purpose.md](./lecture-notes/02-managing-state-on-purpose.md) | The four kinds of state; Context vs Zustand; SecureStore; why server state is different |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises + the working checklist |
| [exercises/exercise-01-stack-and-tabs.md](./exercises/exercise-01-stack-and-tabs.md) | Guided: wire a typed stack + bottom-tab navigator from scratch |
| [exercises/exercise-02-habit-form.tsx](./exercises/exercise-02-habit-form.tsx) | Runnable: a controlled, validated multi-field add-habit form |
| [exercises/exercise-03-session-store.ts](./exercises/exercise-03-session-store.ts) | Runnable: a Zustand session store with SecureStore persistence |
| [challenges/README.md](./challenges/README.md) | What the challenge is and how it's assessed |
| [challenges/challenge-01-auth-gated-flow.md](./challenges/challenge-01-auth-gated-flow.md) | Build a flicker-free, leak-free auth-gated navigation flow |
| [mini-project/README.md](./mini-project/README.md) | Grow Crunch Tracker into a navigable, stateful app |
