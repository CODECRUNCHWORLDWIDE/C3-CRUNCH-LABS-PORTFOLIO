...
If you scored under 7, re-read the lectures for the questions you missed — most misses cluster on either the boxing/`==` trap (Q2) or exhaustiveness (Q5/Q6). If you scored 9 or 10, you're ready to dive into the [homework](./06-homework.md).
