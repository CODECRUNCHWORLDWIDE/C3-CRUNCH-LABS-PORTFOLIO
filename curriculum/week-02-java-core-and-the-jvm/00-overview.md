...
| [resources.md](./01-resources.md) | Curated, current docs, JEPs, tools, and reading |
| [lecture-notes/01-java-the-language.md](./02-lecture-notes/01-java-the-language.md) | Types, primitives vs objects, records, sealed interfaces, pattern-matching switch, enums |
| [lecture-notes/02-what-the-jvm-actually-does.md](./02-lecture-notes/02-what-the-jvm-actually-does.md) | Bytecode, classloading, JIT, the heap/stack, references, garbage collection |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of short coding drills |
| [exercises/exercise-01-records-and-immutability.md](./03-exercises/exercise-01-records-and-immutability.md) | Scaffold a Maven project; model immutable data with records; run it |
| [exercises/exercise-02-sealed-and-switch.java](./03-exercises/exercise-02-sealed-and-switch.java) | Fill-in-the-TODO sealed hierarchy + exhaustive pattern-matching switch |
| [exercises/exercise-03-absence.java](./03-exercises/exercise-03-absence.java) | Replace null-returning code with `Optional`; choose exception vs `Optional` |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-transaction-ledger.md](./04-challenges/challenge-01-transaction-ledger.md) | Model a transaction ledger with sealed types + records, process it with one exhaustive switch |
...
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the Crunch Tracker core domain model |
