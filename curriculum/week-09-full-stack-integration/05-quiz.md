...
If you scored under 8, re-read the lectures for the questions you missed — especially the difference between `staleTime`/`gcTime` and the optimistic-update lifecycle. If you scored 10 or higher, you're ready for the [homework](./06-homework.md).
