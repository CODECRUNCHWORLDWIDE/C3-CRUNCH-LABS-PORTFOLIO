...
| [resources.md](./resources.md) | Curated Expo, React Native, React, and TypeScript docs and tools |
| [lecture-notes/01-react-native-expo-and-typescript.md](./lecture-notes/01-react-native-expo-and-typescript.md) | What RN, Expo, and TS each are; the toolchain; components, props, JSX, the render model |
| [lecture-notes/02-state-effects-lists-and-styling.md](./lecture-notes/02-state-effects-lists-and-styling.md) | `useState`, `useEffect`, `FlatList`, `StyleSheet`, Flexbox, touch targets |
| [exercises/README.md](./exercises/README.md) | Index of short coding exercises |
| [exercises/exercise-01-scaffold-and-run.md](./exercises/exercise-01-scaffold-and-run.md) | `create-expo-app`, run on simulator + device, first typed component |
| [exercises/exercise-02-habit-card.tsx](./exercises/exercise-02-habit-card.tsx) | Fill-in-the-TODO typed component drill — a reusable `HabitCard` |
| [exercises/exercise-03-habit-list-screen.tsx](./exercises/exercise-03-habit-list-screen.tsx) | A `FlatList` screen with state, an effect, and loading/empty states |
| [challenges/README.md](./challenges/README.md) | Index of weekly challenges |
| [challenges/challenge-01-spec-faithful-screen.md](./challenges/challenge-01-spec-faithful-screen.md) | Rebuild a design-spec screen pixel-faithfully, fully typed |
| [quiz.md](./quiz.md) | 10 multiple-choice questions with an answer key |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the Crunch Tracker mobile client (habit list + add form, mock data) |
