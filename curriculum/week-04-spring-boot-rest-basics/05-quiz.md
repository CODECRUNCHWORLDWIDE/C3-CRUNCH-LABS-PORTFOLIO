...
If you scored under 7, re-read the lectures for the questions you missed — especially Q6 (the `@Valid` trap) and Q4/Q9 (status codes). If you scored 9 or 10, you're ready for the [homework](./06-homework.md).
